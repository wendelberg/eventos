<div class="box box-primary">
	...
	<g:formRemote name="form" url="[action: 'salvar']"
		...
		<input type="hidden" name="eventoSituacao.id"
			value="${eventoSituacao?.id}">

		<input type="hidden" name="eventoSituacao.version"
			value="${eventoSituacao?.version}">
			...
			<div class="col-sm-6 form-group" id="div_nome">
				...
				<div class="input-group">
					...
					<input type="text" class="form-control"
						name="eventoSituacao.nome"
						<g:if test="${!editable}">disabled</g:if> id="nome"
						value="${eventoSituacao?.nome}">
				</div>
			</div>
