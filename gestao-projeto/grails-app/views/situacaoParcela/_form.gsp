<div class="box box-primary">
	...
	<g:formRemote name="form" url="[action: 'salvar']"
		...
		<input type="hidden" name="situacaoParcela.id"
			value="${situacaoParcela?.id}">

		<input type="hidden" name="situacaoParcela.version"
			value="${situacaoParcela?.version}">
			...
			<div class="col-sm-6 form-group" id="div_nome">
				...
				<div class="input-group">
					...
					<input type="text" class="form-control"
						name="situacaoParcela.nome"
						<g:if test="${!editable}">disabled</g:if> id="nome"
						value="${situacaoParcela?.nome}">
				</div>
			</div>
