...
class gsp_springSecurityCore_logindenied_old_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/plugins/spring-security-core-2.0-RC5/grails-app/views/login/denied_old.gsp" }
public Object run() {
Writer out = getOut()
...
public static final long LAST_MODIFIED = 1496850392656L
