...
class gsp_gestaoProjeto_dashboardindex_gsp extends GroovyPage {
...
printHtmlPart(2)
expressionOut.print(createLink(uri: '/adminlte/plugins/chartjs/Chart.min.js'))
printHtmlPart(3)
})
...
public static final long LAST_MODIFIED = 1496850386316L
